...
const TravelForm = ({
  ...
  return (
    <div className="bg-white bg-opacity-20 p-4 rounded-xl mb-12">
      <div
        id="travelForm"
        className="bg-white bg-opacity-75 p-10 px-16 rounded-xl"
      >
        <h1 className="text-3xl mb-10 font-medium text-green-900">
          Plan your journey...
        </h1>
        <form onSubmit={handleSubmit}>
          <div id="from" className="mb-5 text-xl">
            <label htmlFor="from-input" className="text-green-900">
              From:{" "}
            </label>
            <br />
            <input
          ...
          <div id="to" className="mb-5 text-xl">
            <label htmlFor="to-input" className="text-green-900">
              To:{" "}
            </label>
            <br />
            <input
          ...
          <div id="passengers" className="mb-5 text-xl">
            <label htmlFor="passengers-input" className="text-green-900">
